...
# Date: 02-04-2022
# Edited by JBB with Luke on 4/20/2022 to make it run in FunctionApp instead of standalone
# Rob recorded the session so we should have the steps if needed in the future
